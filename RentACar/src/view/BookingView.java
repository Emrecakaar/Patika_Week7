...
public class BookingView extends Layout {
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        this.fld_book_name.setText("Emre Çakar");
        this.fld_book_idno.setText("1235432168");
        this.fld_book_mail.setText("mfadskmsfş@gmail.com");
        this.fld_book_mpno.setText("00354150343511351313");
        this.fld_book_prc.setText("7000");
